# Please note that the following file has been adopted from pyimagesearch.com 
# article on SGD with python. The author of this article is 
# Adrian Rosebrock, PhD. 
# The py file has been modified to calculate cost of calcualting gradient
# decent with one training example to get a probability distribution

# Link: https://www.pyimagesearch.com/2016/10/17/stochastic-gradient-descent-sgd-with-python/
...
# Used 'hard numbers' after relavant range was found
counts, indices = np.histogram(timeHistory, bins = np.arange(8e-6, 4e-5, 1e-6))